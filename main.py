...
def main():
    ...
    while not glfw.window_should_close(window):
        ...
        mercury = glm.rotate(mercury, tempo * 4, glm.vec3(0,1,0))
        ...
        venus = glm.rotate(venus, tempo*1.5, glm.vec3(0,1,0))
        ...
        earth = glm.rotate(earth, tempo, glm.vec3(0,1,0))
        ...
        mars = glm.rotate(mars, tempo / 0.5, glm.vec3(0,1,0))
        ...
        saturn = glm.rotate(saturn, tempo/6, glm.vec3(0,1,0))
        ...
        uranus = glm.rotate(uranus, tempo/8, glm.vec3(0,1,0))
        ...
        neptune = glm.rotate(neptune, tempo/10, glm.vec3(0,1,0))
        ...
        neptune = glm.rotate(neptune, tempo, glm.vec3(0,0,1))
        neptune = glm.translate(neptune, glm.vec3(0,0,0))
        light_shader.set_mat4("model", neptune)
        Orbita3.draw(light_shader)
